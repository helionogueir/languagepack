...
<html>
    <head>
        <title>LanguagePack - Library of control for language pack</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div class="container">
            <div class="container-header">
                <h3>LanguagePack</h3>
                <h4>LanguagePack - Library of control for language pack</h4>
            </div>
            <!-- Result -->
            <div class="form-result">
                <pre>
# Configuration
$locale = helionogueir\typeBoxing\type\String('en-US');
$root = helionogueir\typeBoxing\type\String(dirname(__FILE__));
helionogueir\languagepack\Lang::configuration($locale, $root);

# Get Lang
$title = helionogueir\languagepack\Lang::get('languagepack:title', 'core');
$desc = helionogueir\languagepack\Lang::get('languagepack:desc', 'core');
                </pre>
            </div>
            <!-- /Result -->
        </div>
